...
\section{Talen en Automaten}
	...
	\end{stel}
	\newpage
	\todo[inline]{bewijs dat het aantal Turingmachines aftelbaar oneindig is.}
	\todo[inline]{bewijs dat een Turingmachine juist één taal herkent.}
\begin{stel}
...
\begin{zDoen}
	...
	\end{itemize}
\end{zDoen}
\todo[inline]{Zelf doen beantwoorden}
\newpage
\textbf{\LARGE SIPSER}\\
...
\subsubsection{Een taal is context vrij als en slechts als ze geaccepteerd wordt door een PDA.}
	\begin{lemma}[$\Rightarrow$]
		...
		\end{bewijs}
	\end{lemma}
	\todo[inline]{Bewijs PDA afwerken}
...
\paragraph{Chomsky Normaal Vorm}
	...
	\todo[inline]{Hoofdstuk verder afwerken}
